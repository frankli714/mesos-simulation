...
class Framework : public Indexable {
 public:
  Framework() : cpu_share(0), mem_share(0), disk_share(0), dominant_share(0), has_available_task(false) {}
  ...
  bool has_eligible_tasks(const Indexer<Task>& tasks,
                          double current_time) const;
