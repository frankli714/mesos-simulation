...
%\begin{center}
    ...
    \hline
    \small Envy-Free & \cmark &  & Locally\footnote{No framework envies a framework that pays less.} \\
    \small Pareto-Efficient & \cmark & Locally\footnote{With caveats arising from computational hardness of packing problems.} & Locally\footnote{With caveats arising from computational hardness of packing problems}  \\
