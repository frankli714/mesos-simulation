...
task it wishes to run. We now describe some reasonable ways for the frameworks
to do so.

\paragraph{Default policy} For backwards compatibility, we want to be able to
...
\begin{center}
    ...
    \hline
    Desired & \small DRF & \small DRF & \small Market-based  & something & something\\
    Properties & \small(simple) & \small (complex) & \small Mechanism  & something & something\\
    \hline
    \small Envy-Freeness & \cmark & \cmark  & \cmark & \cmark   & \cmark\\
    \small Pareto-Efficiency & 5 & 6  & 4  & \cmark  & \cmark\\
    \small Resource Monotonicity & 8 & 9  & 4  & \cmark  & \cmark \\
    7 & 8 & 9  & 4  & \cmark  & \cmark \\
    7 & 8 & 9  & 4  & \cmark  & \cmark\\
    7 & 8 & 9  & 4 & \cmark  & \cmark\\
    \hline
...
Finally, Figure \ref{img:reg_fairness} displays the split-wise share of cluster resources each of the five frameworks are allocated in the market-based mechanism. Under high contention, all five frameworks have queued tasks to run, and we see that each framework gets roughly a fifth of the cluster resources. This indicates the market-based mechanism allocates resources fairly , similar to DRF.
